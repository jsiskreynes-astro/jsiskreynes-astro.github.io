...
My research focuses on understanding the growth, structure, and physical processes governing supermassive black holes (SMBHs) and their galactic environments over cosmic time. I am also interested in using astrophysical sources as probes of physics beyond the Standard Model. I approach these areas by combining observational data, computational modeling, and statistical inference, with a particular emphasis on strong gravitational lensing and high-energy astrophysics. 
