...
E1.18 session on "Revolutionising High-Energy Astrophysics with NewAthena."
...
Symposium 4 on "Preparing for multi-messenger observations with LISA and PTAs SYmposium". 
...
Special HEAD Session on "Chirps and Flashes: Converging on Black Hole Spin from GWs to X-rays".
Presentation: *Probing supermassive black hole spin demographics from X-rays.* 
Delivered by Prof. Christopher S. Reynolds on my behalf.

---

**June 2026 — X-ray Universe 2026, Elche (Contributed)**  
AGN, TDEs & QPEs session. 
Presentation (i): *Chandra spectroscopy confirms the tightest-separation dual AGN in a gravitationally lensed radio-loud system at z = 3.23*.  
Presentation (ii): *Probing sub-kiloparsec X-ray structure in high-redshift AGN with strong gravitational lensing*.
